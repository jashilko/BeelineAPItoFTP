...
## Логгирование работы сервиса
В зависимости от уровня логгирования DEBUG, INFO, ERROR сервис будет логгировать свою работу в разном объеме. Рекомендуемый режим логгирования - INFO. Установить режим можно в файле настроек. 

В режиме INFO сервис записывает время начала и конца работы, количество загруженных на FTP файлов, имя первого и последнего файла